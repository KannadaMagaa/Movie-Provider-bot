...
URL = "https://testy-zonda-ravikumar.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://testy-zonda-ravikumar.koyeb.app/:8000/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://testy-zonda-ravikumar.koyeb.app/".format(FQDN)
else:
    URL = "http://testy-zonda-ravikumar.koyeb.app/".format(FQDN)
